...
while true
  ...
  if user_string.downcase == 'quit'
    ...
    shift_factor = gets.to_i # Gathers shift factor in integer form
    user_string = caesar_cipher(user_string, shift_factor) #Applies function caesar_cipher to user_string with new shift_factor
